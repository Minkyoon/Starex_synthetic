...
#model = torch.load('/data/gongmo/team1/gongmo_2023/5-fold_minkyoon/results/fold0_resnet50_pi.pt')
...
for fold_num in range(5):
    ...
    train_path = f"/data/gongmo/team1/gongmo_2023/csv/externel_5fold/train_fold{fold_num}.csv"
    valid_path = f"/data/gongmo/team1/gongmo_2023/csv/externel_5fold/valid_fold{fold_num}.csv"
    test_path = f"/data/gongmo/team1/gongmo_2023/csv/externel_5fold/test_fold{fold_num}.csv"
