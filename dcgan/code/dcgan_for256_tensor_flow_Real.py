...
Images = []
images_path = '/data/gongmo/team1/covid_data/normaldata/Normal'  # Change this to your own path
files = os.listdir(images_path)
for n in files:
    temp1 = Image.open(os.path.join(images_path, n))
                
    temp = np.array(temp1.convert('RGB').resize((256, 256)), dtype='float32')
...
class Model_GAN(object):
    ...
    def save(self, num):
        ...
        with open("/data/gongmo/team1/covid_data/covid-chestxray-dataset/data/Models/gen.json", "w+") as json_file:  # Change this to your own path
            json_file.write(gen_json)

        with open("/data/gongmo/team1/covid_data/covid-chestxray-dataset/data/Models/dis.json", "w+") as json_file:  # Change this to your own path
            json_file.write(dis_json)

        self.GAN.G.save_weights("/data/gongmo/team1/covid_data/covid-chestxray-dataset/data/Models2/gen"+str(num)+".h5")  # Change this to your own path
        self.GAN.D.save_weights("/data/gongmo/team1/covid_data/covid-chestxray-dataset/data/Models2/dis"+str(num)+".h5")  # Change this to your own path
    ...
    def eval2(self, num = 0):
        ...
        x.save("Results2/i"+str(num)+".png")
        
        
# os.mkdir('Results')
# os.mkdir('Models')
# os.mkdir('/data/gongmo/team1/covid_data/covid-chestxray-dataset/data/Results')  # Change this to your own path
# os.mkdir('/data/gongmo/team1/covid_data/covid-chestxray-dataset/data/Models')  # Change this to your own path
...
generator.load_weights('/data/gongmo/team1/covid_data/covid-chestxray-dataset/data/Models2/gen24.h5')

# 이미지를 저장할 디렉토리 생성
os.makedirs('generated_images_normal_synr', exist_ok=True)
...
for i in range(1000):
    ...
    # 이미지 생성
    img_array = generator.predict(noisee)[0]
    ...
    # 이미지 저장
    img.save(f'generated_images_normal_synr/generated_{i}.png')
