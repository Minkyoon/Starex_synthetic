...
train_df = pd.read_csv(f'/data/gongmo/team1/gongmo_2023/csv/ddpm_for_128_10000/train_fold{num}.csv')
X_train = []
y_train = []
...
test_df = pd.read_csv(f'/data/gongmo/team1/gongmo_2023/csv/ddpm_for_128_10000/test_fold{num}.csv')
X_test = []
y_test = []
