...
train_df = pd.read_csv('/data/gongmo/team1/gongmo_2023/csv/covidcollection_5fold/train_fold0.csv')
X_train = []
y_train = []
...
test_df = pd.read_csv('/data/gongmo/team1/gongmo_2023/csv/covidcollection_5fold/test_fold0.csv')
X_test = []
y_test = []
